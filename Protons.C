...
//Protons
TH1I* np = new TH1I("np","Number of Tracks FS Protons are split into",10,.5,10.5);
...
//Muons
TH1I* nm = new TH1I("nm","Number of Tracks FS Muons are split into",10,.5,10.5);
...
//Charged Pions
TH1I* ncp = new TH1I("ncp","Number of Tracks FS Charged Pions are split into",10,.5,10.5);
...
//Charged Kaons
TH1I* nk = new TH1I("nk","Number of Tracks FS Charged Kaons are split into",10,.5,10.5);
...
for(UInt_t ipdg = 0; ipdg<particle_types.size(); ipdg++)
{
	for(UInt_t ientry=0; ientry<treeman->NEntries(); ientry++)	//Loop through all events
		...
		for(UInt_t ig4p = 0; ig4p<g4->NSim(); ig4p++)		//Loop through all true particles
		{
				...
				for(UInt_t itrk = 0; itrk<reco->NTrack(); itrk++) //Loop through all tracks for event
				{
					...
					for(auto iter = ParticleList.begin(); iter != ParticleList.end(); iter++) //Loop through resposible particles for given track
					{
						if(ig4p==iter->first && iter->second>.005)	//associate protons to tracks and assert lower cutoff to energy reconstruction
						{
							...
							if(.8>iter->second/reco->TrackTrueEnergy(itrk)>.2)
							{
								specs.at(3*ipdg+1)->Fill(g4->SimMomEnter(iter->first,0)->P());
							}
							if(iter->second/reco->TrackTrueEnergy(itrk)<.2)
							{
								specs.at(3*ipdg+2)->Fill(g4->SimMomEnter(iter->first,0)->P());
							}
						}
					}
				}	
			...
			//sort(EOrder.begin(), EOrder.end(), greater<double>());
			sort(EnergyOrder.begin(), EnergyOrder.end(), greater<double>());
			//for(int i=0; i<EOrder.size(); i++)
			//{
			//	std::cout<<"EOrder: "<<EOrder.at(i)<<", EnergyOrder: "<<EnergyOrder.at(i)<<std::endl;
			//}
...
ns.at(0)->GetXaxis()->SetRangeUser(0.,6.);
ns.at(0)->Draw("E");
c1->Print("prosplit.png");

TCanvas* c2 = new TCanvas("c2","Proton Energy Deposition per Track",1000,1000);
c2->Divide(2,2);
c2->cd(1);
ts.at(0)->SetTitle("Proton Primary Track");
ts.at(0)->GetXaxis()->SetTitle("Percent of true energy deposited (GeV)");
ts.at(0)->Draw("E");

c2->cd(2);
ts.at(1)->SetTitle("Proton Secondary Track");
ts.at(1)->GetXaxis()->SetTitle("Percent of true energy deposited (GeV)");
ts.at(1)->Draw("E");

c2->cd(3);
ts.at(2)->SetTitle("Proton Tertiary Track");
ts.at(2)->GetXaxis()->SetTitle("Percent of true energy deposited (GeV)");
ts.at(2)->Draw("E");

c2->cd(4);
ts.at(3)->SetTitle("Proton Quaternary Track");
ts.at(3)->GetXaxis()->SetTitle("Percent of true energy deposited (GeV)");
ts.at(3)->Draw("E");
c2->Print("propertrack.png");

TCanvas* c3 = new TCanvas("c3","Proton Cleanliness",1500,750);
c3->Divide(2,2);
c3->cd(1);
cls.at(0)->SetTitle("Proton Cleanliness");
cls.at(0)->GetXaxis()->SetTitle("Percent of TrackTrueEnergy that is deposited by proton");
cls.at(0)->Draw("E");

c3->cd(2);
specs.at(0)->SetTitle("Spectrum for protons >80% responsible for a track");
specs.at(0)->GetXaxis()->SetTitle("Momentum (GeV)");
specs.at(0)->GetXaxis()->SetRangeUser(0.,3.);
specs.at(0)->Draw("E");

c3->cd(3);
specs.at(1)->SetTitle("Spectrum for protons between 20 and 80% responsible for a track");
specs.at(1)->GetXaxis()->SetTitle("Momentum (GeV)");
specs.at(1)->GetXaxis()->SetRangeUser(0.,3.);
specs.at(1)->Draw("E");

c3->cd(4);
specs.at(2)->SetTitle("Spectrum for protons <20% responsible for a track");
specs.at(2)->GetXaxis()->SetTitle("Momentum (GeV)");
specs.at(2)->GetXaxis()->SetRangeUser(0.,3.);
specs.at(2)->Draw("E");
c3->Print("proclean.png");

//Muons
TCanvas* c4 = new TCanvas("c4","Muon Splitting",1000,1000);
ns.at(1)->GetXaxis()->SetRangeUser(0.,6.);
ns.at(1)->Draw("E");
c4->Print("musplit.png");
...
ts.at(7)->Draw("E");
c5->Print("mupertrack.png");

TCanvas* c6 = new TCanvas("c6","Muon Cleanliness",1500,750);
c6->Divide(2,2);
c6->cd(1);
cls.at(1)->SetTitle("Muon Cleanliness");
cls.at(1)->GetXaxis()->SetTitle("Percent of TrackTrueEnergy that is deposited by muon");
cls.at(1)->Draw("E");
...
c6->cd(3);
specs.at(4)->SetTitle("Spectrum for muons between 20 and 80% responsible for a track");
specs.at(4)->GetXaxis()->SetTitle("Momentum (GeV)");
specs.at(4)->GetXaxis()->SetRangeUser(0.,3.);
specs.at(4)->Draw("E");

c6->cd(4);
specs.at(5)->SetTitle("Spectrum for muons <20% responsible for a track");
specs.at(5)->GetXaxis()->SetTitle("Momentum (GeV)");
specs.at(5)->GetXaxis()->SetRangeUser(0.,3.);
specs.at(5)->Draw("E");
c6->Print("muclean.png");

//Charged Pions
TCanvas* c7 = new TCanvas("c7","Charged Pion Splitting",1000,1000);
ns.at(2)->GetXaxis()->SetRangeUser(0.,6.);
ns.at(2)->Draw("E");
c7->Print("pisplit.png");
...
ts.at(11)->Draw("E");
c8->Print("pipertrack.png");

TCanvas* c9 = new TCanvas("c9","Charged Pion Cleanliness",1500,750);
c9->Divide(2,2);
c9->cd(1);
...
c9->cd(3);
specs.at(7)->SetTitle("Spectrum for charged pions between 20 and 80% responsible for a track");
specs.at(7)->GetXaxis()->SetTitle("Momentum (GeV)");
specs.at(7)->GetXaxis()->SetRangeUser(0.,3.);
specs.at(7)->Draw("E");

c9->cd(4);
specs.at(8)->SetTitle("Spectrum for charged pions <20% responsible for a track");
specs.at(8)->GetXaxis()->SetTitle("Momentum (GeV)");
specs.at(8)->GetXaxis()->SetRangeUser(0.,3.);
specs.at(8)->Draw("E");
c9->Print("piclean.png");

//Charged Kaons
TCanvas* c10 = new TCanvas("c10","Charged Kaon Splitting",1000,1000);
ns.at(3)->GetXaxis()->SetRangeUser(0.,6.);
ns.at(3)->Draw("E");
c10->Print("ksplit.png");
...
ts.at(15)->Draw("E");
c11->Print("kpertrack.png");

TCanvas* c12 = new TCanvas("c12","Charged Kaon Cleanliness",1500,750);
c12->Divide(2,2);
c12->cd(1);
...
c12->cd(3);
specs.at(10)->SetTitle("Spectrum for charged kaons between 20 and 80% responsible for a track");
specs.at(10)->GetXaxis()->SetTitle("Momentum (GeV)");
specs.at(10)->GetXaxis()->SetRangeUser(0.,3.);
specs.at(10)->Draw("E");

c12->cd(4);
specs.at(11)->SetTitle("Spectrum for charged kaons <20% responsible for a track");
specs.at(11)->GetXaxis()->SetTitle("Momentum (GeV)");
specs.at(11)->GetXaxis()->SetRangeUser(0.,3.);
specs.at(11)->Draw("E");
c12->Print("kclean.png");
}
